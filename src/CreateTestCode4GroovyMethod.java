 ...
 */
public class CreateTestCode4GroovyMethod extends EditorAction {

    protected CreateTestCode4GroovyMethod() {
        super(new CreateTestCode4GroovyMethod.Handler());
    }
...
//            basePath = psiFile.getProject().getBasePath() + "/scm-common/target/classes/com/social/credits/common/rest/";
                for (PsiClass psiClass : ((PsiJavaFileImpl) psiFile).getClasses()) {
                    ...
                    frame = StaticBuildMethod.createMethodTree4Groovy(psiClass, keyListener, mouseListener, editor.getSelectionModel().getSelectedText());
